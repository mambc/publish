var Publish = {
	...
	"data": {
		...
		"regionsTemporalSnapshot": {
			...
			"geom": "MultiPolygon",
			"transparency": 1,
			"id": "regionsTemporalSnapshot",
			"download": true,
			"description": "Regions of Caraguatatuba.",
			"group": "Border",
			"order": 2,
			"timeline" : [1978, 2000, 2016],
			"name": ["regionsTemporal_1978", "regionsTemporal_2000", "regionsTemporal_2016"],
			"time": "snapshot"
		},	
		"regionsTemporalCreation": {
			"width": 1,
			"select": "name",
			"visible": false,
			"report": "table",
			...
			"geom": "MultiPolygon",
			"transparency": 1,
			"id": "regionsTemporalCreation",
			"download": true,
			"description": "Regions of Caraguatatuba.",
			"group": "Border",
			"order": 2,
			"timeline" : [1978, 2000, 2016],
			"name": "regionsTemporalCreation",
			"time": "creation",
			"select": "data_criacao"
		},
		"ucEstaduais": {
			...
			"id": "ucestadual",
			"url": "http://130.211.170.236:8580/geoserver/wms",
			"timeline" : [1978, 2000, 2007, 2016],
			"name": ["inpe:ucEstaduais_1978", "inpe:ucEstaduais_2000", "inpe:ucEstaduais_2007","inpe:ucEstaduais_2016"],
			"time": "snapshot"
		},
		"ucFederais": {
			"geom": "WMS",
			...
			"id": "ucfederal",
			"url": "http://130.211.170.236:8580/geoserver/wms",
			"timeline" : [1990, 2005, 2016],
			"name": ["inpe:ucFederais_1990", "inpe:ucFederais_2005", "inpe:ucFederais_2016"],
			"time": "snapshot"
		}
	}
};