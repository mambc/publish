$(function () {
	...
	// TESTE
	function addPath (linePath, id) {
		var mdata = data[id];
		mdata.forEach(function (feature) {
			var geom = feature.getGeometry();
			var type = geom.getType();
			if (type == "LineString" || type == "MultiLineString") {
				geom.forEachLatLng(function (latLong) {
	...
	function createPolyline() {
		var linePath = [];
		addPath(linePath, "beginning");
		addPath(linePath, "ending");
		...
		window.polyline = new google.maps.Polyline(lineOptions);
		polyline.setMap(map);
